-- MUTACIÓN 6 — levantar_multa atrapa el error del cobro "para que no truene".
-- Es la tentación más realista de todas, y deja el expediente creado sin cargo:
-- una multa que existe en la bandeja y que nadie cobró nunca.
...
BEGIN
  ...
  EXCEPTION WHEN others THEN
    v_res := '{}'::jsonb;   -- ← el expediente se queda, el cobro no ocurrió
  END;
