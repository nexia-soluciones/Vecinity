...
-- ------------------------------------------------------------
CREATE OR REPLACE FUNCTION mifracc.registrar_visita_manual(
  p_nombre         text,
  p_house_id       uuid,
...
-- ------------------------------------------------------------
CREATE OR REPLACE FUNCTION mifracc.adjuntar_fotos_visita(
  p_id             uuid,
  p_foto_ine_url   text DEFAULT NULL,
  p_foto_placa_url text DEFAULT NULL
)
...
GRANT EXECUTE ON FUNCTION mifracc.registrar_visita_manual(text,uuid,text,text,text) TO authenticated, service_role;
GRANT EXECUTE ON FUNCTION mifracc.adjuntar_fotos_visita(uuid,text,text)             TO authenticated, service_role;
