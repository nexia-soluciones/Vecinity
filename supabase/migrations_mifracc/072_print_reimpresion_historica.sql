...
REVOKE EXECUTE ON FUNCTION mifracc.print_encolar_reimpresion(uuid) FROM PUBLIC, authenticated, anon;
GRANT EXECUTE ON FUNCTION mifracc.print_encolar_reimpresion(uuid) TO service_role;
