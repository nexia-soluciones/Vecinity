-- TODO(mifracc): excluido del set mifracc — la UPDATE apunta a URLs reales de producción (bucket vecino-tarjetas, imágenes ya subidas de Villa Catania). No aplica a un fraccionamiento sintético/demo. Pendiente: decidir si mifracc necesita su propio diseño de tarjeta y bucket, o si esta migración simplemente no debe replicarse.
