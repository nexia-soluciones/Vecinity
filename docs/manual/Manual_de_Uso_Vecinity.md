# 📖 Manuales de Uso — Vecinity

> **Vecinity** es la app de tu colonia: te mantiene informado, te conecta con
> el comité y hace tu comunidad **más segura y organizada**.

Desde la versión de julio 2026, el manual está dividido **por rol** para que
cada quien tenga solo lo que necesita:
...
- **2026-07-15** — Manual dividido por rol. Nuevo: cámara en vivo y apertura
  remota de la puerta peatonal (vecinos, comité y guardias), rostro para la
  puerta peatonal, mi estado de cuenta con recibos, comunicados, calendario
  de reservas, multas por casa, conciliación con banco persistente,
  credenciales PVC y bitácoras de acceso.
- Versión original (un solo documento): ver historial de git.
